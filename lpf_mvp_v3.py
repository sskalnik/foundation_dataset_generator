...
class LPFPredictor:
    ...
    def train(
        ...
        trainer = Trainer(
            ...
            logger=logger,
            log_every_n_steps=50, # Default value to not thrash the SSD
            enable_progress_bar=True,
            num_sanity_val_steps=0,  # Default value of 2; set to 0 unless needed for troubleshooting
            #limit_train_batches=1.0,  # Use all training data
            #limit_val_batches=1.0,   # Use all validation data
            profiler="simple" # https://lightning.ai/docs/pytorch/stable/tuning/profiler.html
        )
