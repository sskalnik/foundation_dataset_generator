...
from pytorch_lightning.callbacks import ModelCheckpoint, EarlyStopping, RichModelSummary
...
class LPFMultiOutput(LightningModule):
    ...
    def validation_step(self, batch: Tuple[torch.Tensor, torch.Tensor, torch.Tensor], batch_idx: int) -> Dict[str, Any]:
        ...
        self.log('val_mae', mae, on_epoch=True, prog_bar=True, prog_bar=True)
...
class LPFPredictor:
    ...
    def train(
        ...
        trainer = Trainer(
            ...
            limit_val_batches=1.0,   # Use all validation dat
        )
