    ...
    def train(
        ...
        if use_optimized:
            ...
            datamodule = OptimizedLPFDataModule(
                ...
                n_fft=self.n_fft,
                hop_length=self.hop_length,
                prefetch_factor=128,  # Increased from 32
        ...
        print(f"Optimized mode (pre-transform dataset and load into VRAM + system RAM): {use_optimized}")
        print("-" * 60)
...
Examples:
  ...
  python lpf_predictor.py --stats --data-dir ./training_data
    ...
    parser.add_argument('--num-workers', type=int, default=0,
                       help='Integer number of workers for data loading (default: 0)')
